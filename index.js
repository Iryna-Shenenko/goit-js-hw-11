import{S as f,i as l}from"./assets/vendor-5ObWk2rO.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const g="46059319-29801eb93901e255329030081";function y(s){const o="https://pixabay.com/api/?key="+g+"&q="+encodeURIComponent(s)+"&per_page=45&image_type=photo&orientation=horizontal&safesearch=true";return fetch(o).then(r=>{if(!r.ok)throw new Error(r.status);return r.json()}).catch(r=>console.log("Error:",r))}function p(s){const o=document.querySelector(".image-gallery");o.innerHTML="";const r=s.hits.map(i=>{const{webformatURL:e,largeImageURL:t,tags:n,views:c,downloads:m,likes:u,comments:d}=i;return`
          <li class="gallery-item">
            ...
            <div class="overlay">
            <div class="info">
                <div class="overlay-item">Likes<br>${u}</div>
                <div class="overlay-item">Views<br>${c}</div>
                <div class="overlay-item">Comments<br>${d}</div>
